<div>
    ...
    <div class="mb-3 row">
        <div class="col-12">
            <h1 class="mb-2 h4 mb-sm-0">Candidats validés
                <span class="badge bg-success bg-opacity-10 text-success">{{ $valide_candidates }}</span>
            </h1>
        </div>
    </div>
    <!-- Main card START -->
            ...
            <div class="row g-3 align-items-center justify-content-between">
                ...
                <div class="col-md-12">
                    <form class="rounded position-relative">
                        <input class="form-control bg-body" type="search" placeholder="Recherche..."
                            aria-label="Search">
                        <button
                        ...
                        <tr>
                                ...
                                <div class="d-flex align-items-center position-relative">
                                    <div class="flex-shrink-0 avatar avatar-md">
                                        <div class="avatar-img rounded-circle bg-purple bg-opacity-10">
                                            <span
                                                class="text-purple position-absolute top-50 start-50 translate-middle fw-bold">
                                    ...
                                    <div class="mb-0 ms-2">
                                        <!-- Title -->
                                        <h6 class="mb-0">
                                            <a href="#!" wire:click="detail({{ $candidate->id }})"
                                                data-bs-toggle="modal" data-bs-target="#candidatInfo"
                            ...
                            <td>
                                <button class="mb-1 btn btn-danger-soft me-1 mb-lg-0" data-bs-toggle="modal"
                                    data-bs-target="#rejeter"
                                    wire:click="setCandidateId('{{ $candidate->id }}')">Annuler
                                </button>
                                <a href="{{ route('project_file', ['id' => $candidate->id, 'uuid' => $candidate->uuid]) }}"
                                    target="_blank" class="mb-0 btn btn-success me-1">
                                    Voir projet
                                </a>
                            </td>
                        </tr>
